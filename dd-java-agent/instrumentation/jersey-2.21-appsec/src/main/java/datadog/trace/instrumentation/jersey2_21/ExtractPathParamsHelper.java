...
public class ExtractPathParamsHelper {
  private final static MethodHandle PARAMETER_FUNCTION_FIELD_GETTER;
  private final static Class<?> SEGMENT_VALUE_SUPPLIER_CLASS;
  private final static MethodHandle NAME_FIELD_GETTER;
  private final static MethodHandle SOURCE_GETTER;
  ...
  static {
    ...
    try {
      ...
      MethodHandle getName = lookup.findVirtual(extractorClass, "getName", MethodType.methodType(String.class));
