...
public class ParameterValueHelperInstrumentation extends Instrumenter.AppSec
  ...
  private static final IReferenceMatcher GET_SOURCE_OLD_REFERENCE_MATCHER =
      new ReferenceMatcher(
          new Reference.Builder("org.glassfish.jersey.server.spi.internal.ParamValueFactoryWithSource")
              .withMethod(new String[0], Reference.EXPECTS_PUBLIC | Reference.EXPECTS_NON_STATIC, "getSource",
  ...
  private static final IReferenceMatcher EXTRACTOR_REFERENCE_MATCHER =
      new ReferenceMatcher(
          new Reference.Builder("org.glassfish.jersey.server.internal.inject.MultivaluedParameterExtractor")
              .withMethod(new String[0], Reference.EXPECTS_NON_STATIC | Reference.EXPECTS_PUBLIC, "getName", "Ljava/lang/String;")
              .build());
  ...
  private static final IReferenceMatcher EXTRACT_PATH_HELPER_OLD_REFERENCE_MATCHER =
      new IReferenceMatcher.ConjunctionReferenceMatcher(
          new ReferenceMatcher(
              new Reference.Builder("org.glassfish.jersey.server.spi.internal.ParamValueFactoryWithSource")
                  .withField(new String[0], Reference.EXPECTS_NON_STATIC, "factory", "Lorg/glassfish/hk2/api/Factory;")
                  .build()),
          new ReferenceMatcher(
              new Reference.Builder("org.glassfish.jersey.server.internal.inject.PathParamValueFactoryProvider$PathParamValueFactory")
                  .withField(new String[0], Reference.EXPECTS_NON_STATIC, "extractor", "Lorg/glassfish/jersey/server/internal/inject/MultivaluedParameterExtractor;")
                  .build())
      );
  ...
  private static final IReferenceMatcher EXTRACT_PATH_HELPER_NEW_REFERENCE_MATCHER =
      new IReferenceMatcher.ConjunctionReferenceMatcher(
          new ReferenceMatcher(
              new Reference.Builder("org.glassfish.jersey.server.spi.internal.ParamValueFactoryWithSource")
                  .withField(new String[0], Reference.EXPECTS_NON_STATIC, "parameterFunction", "Ljava/util/function/Function;")
                  .build()),
          new ReferenceMatcher(
              new Reference.Builder("org.glassfish.jersey.server.internal.inject.PathParamValueParamProvider$PathParamListPathSegmentValueSupplier")
                  .withField(new String[0], Reference.EXPECTS_NON_STATIC, "name", "Ljava/lang/String;")
                  .build())
      );
  ...
  private IReferenceMatcher postProcessReferenceMatcher(final ReferenceMatcher origMatcher) {
    return new IReferenceMatcher.ConjunctionReferenceMatcher(
        new IReferenceMatcher.ConjunctionReferenceMatcher(
            ...
            new IReferenceMatcher.DisjunctionReferenceMatcher(
                GET_SOURCE_NEW_REFERENCE_MATCHER,
                GET_SOURCE_OLD_REFERENCE_MATCHER
            )
        ),
